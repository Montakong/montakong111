            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="#">ประเภท ผัด</li>
                            <li><a href="#">ประเภท แกง</li>
                            <li><a href="#">ประเภท ทอด</li>
                            <li><a href="#">ประเภท ต้ม</li>
                            <li><a href="#">ประเภท อาหารจานเดียว</li>
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="#">
                                ...
                                <input type="text" placeholder="คุณต้องการอะไร ?">
                    ...
                    <div class="hero__item set-bg" data-setbg="promote/img/hero/Chomas.jpg">
                        <div class="hero__text">
                            <span>FRUIT FRESH</span>
                            <h2>chormung <br />restaurant</h2>
                            <p></p>
                            <a href="#" class="primary-btn">สั่งสินค้าด่วน</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="promote/img/featured/kapao.jpg">
                            <h5><a href="#">ข้าวกะเพราหมูสับ</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="promote/img/featured/mush.jpeg">
                            <h5><a href="#">ข้าวผัด</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="promote/img/featured/PIGTHAI.jpg">
                            <h5><a href="#">หมูทอดกระเทียม</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="promote/img/featured/SUKI.jpg">
                            <h5><a href="#">สุกี้ทะเล</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="promote/img/featured/lason.jpg">
                            <h5><a href="#">ราดหน้า</a></h5>
                        </div>
                    </div>
                </div>
            </div>
